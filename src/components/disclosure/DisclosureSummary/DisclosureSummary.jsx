          ...
          <section className="bg-gray-50 rounded-lg p-6 mb-6">
            <h1 className="text-lg font-bold mb-2">공시 사유</h1>
              <div className="flex items-start">
                <div className="inline-block bg-white border border-gray-300 rounded-full px-3 py-1 text-sm font-medium mr-3">
                </div>
                {/* item number */}
                <div>
                  <p className="font-bold text-lg">경영진 변화</p>
                  <p className="text-gray-600">CEO 교체 발표 (Elon Musk → Tom Zhu)</p>
                </div>
              </div>
          </section>
          {/* 탭 네비게이션 */}
        ...
        {activeTab === "핵심 내용" && (
          <ul className="list-disc pl-6 space-y-4">
            <li className="text-lg">
              Tesla는 Elon Musk가 CEO직에서 사임하고, Tom Zhu가 신임 CEO로 임명되었음을 발표함.
            </li>
            <li className="text-lg">이사회는 2025년 3월 1일부터 변경이 유효함을 승인함.</li>
            <li className="text-lg">Musk는 이사회 의장직 유지 및 제품 혁신 담당 역할 수행 예정.</li>
          </ul>
        )}
              ...
              {outlook && (
                <div className="w-full flex-col items-start space-y-2 p-4 border-1 border-gray-300 border-l-green-500 border-l-3 rounded-lg transition-transform hover-container hover: duration-300 hover:scale-105">
                  <div className="flex items-center gap-2">
                    ...
                    <h4 className="font-semibold text-green-700">장단기 전망</h4>
                  </div>
                  <p
