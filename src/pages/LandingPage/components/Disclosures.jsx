...
export default function Disclosures() {
  ...
  return (
    <div className="w-full p-4">
      ...
      <div className="flex p-3 items-center cursor-pointer" onClick={() => navigate("/disclosures")}>
      <h1
        className="text-[18px] font-bold hover:text-blue-md mb-1 mr-2"
        
      >
        실시간 <span className={isYellow ? "text-yellow-500" : "text-blue-md"}>NEW</span> 해외공시</h1>
